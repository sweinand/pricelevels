...
expect_equal(
  data[, geks(x=price, r=region, n=product)],
  c("r1"=1)
)
...
geks.est1 <- data[, geks(x=price, r=region, n=product, base="r1")]
geks.est2 <- data[, geks(x=price, r=region, n=product, base=NULL)]
jev.est1 <- data[, jevons(x=price, r=region, n=product, base="r1")]
...
geks.est1 <- data[, geks(x=price, r=region, n=product, w=weight, type="toernq", base="r1")]
geks.est2 <- data[, geks(x=price, r=region, n=product, w=weight, type="toernq", base=NULL)]
toernq.est1 <- data[, toernq(x=price, r=region, n=product, w=weight, base="r1")]
