...
expect_no_error(
  .check.nlcpd.start(x=list("lnP"=1, "pi"=c(1,2), "delta"=1:3), len=c(1,2,3))
)

expect_error(
  .check.nlcpd.start(x=list("lnP"=1, "pi"=c(1,2), "delta"=1:3), len=c(1,2,2))
)

expect_error(
  .check.nlcpd.start(x=list("pi"=c(1,2), "delta"=1:3), len=c(1,2,2))
)

expect_error(
  .check.nlcpd.start(x=list("lnP"="abc", "pi"=c(1,2), "delta"=1:3), len=c(1,2,2))
)

expect_error(
  .check.nlcpd.start(x=list("bla"=1, "pi"=c(1,2), "delta"=1:3), len=c(1,2,2))
)
