...
expect_equal(
  data[, jevons(x=price, r=region, n=product)],
  c("r1"=1)
)

expect_equal(
  data[, carli(x=price, r=region, n=product)],
  c("r1"=1)
)

expect_equal(
  data[, dutot(x=price, r=region, n=product)],
  c("r1"=1)
)

expect_equal(
  data[, harmonic(x=price, r=region, n=product)],
  c("r1"=1)
)
