...
- Geradi method `geradi()` used by @Eurostat1978;
...
The *Geradi index* and the *Iklé-Dikhanov-Balk (IDB) index* define the price levels exactly in the same way as the Geary-Khamis index. However, they define the international product prices differently. For the Geradi index, the $\pi_n$'s are computed as simple geometric averages of the prices,
...
# Some further package specifics
