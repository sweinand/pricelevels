...
- Marshall-Edgeworth index [@Marshall1887; @Edgeworth1925]: $$P_{\text{Marshall-Edgeworth}}^{sr} = \frac{\sum_{n=1}^N p_n^r \left( q_n^r + q_n^s \right)}{\sum_{n=1}^N p_n^s \left( q_n^r + q_n^s \right)}$$
